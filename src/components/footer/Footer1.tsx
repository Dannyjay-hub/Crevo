                ...
                <Row>
                    <Col xl={4}>
                        ...
                        <p className="text-muted w-75">
                            Crevo is a shared verifiable credentialing platform that allows students to store and share their educational records with institutions and employers using blockchain technology.
                        </p>
                    </Col>
