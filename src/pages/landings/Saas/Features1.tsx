...
// images
import hero2 from 'assets/images/issuer_hero.jpg';
            ...
            <Container>
                <Row className="justify-content-center">
                    <Col className="text-center">
                        ...
                        <h1 className="display-5 fw-medium">Safe, Faste and Easy</h1>
                        <p className="text-muted mx-auto">
                            Start working with <span className="text-primary fw-bold">Crevo</span> to manage your
                            credentials better
                        </p>
                    </Col>
                </Row>
